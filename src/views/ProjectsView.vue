		...
		<main
			...
			<div class="relative flex w-full">
				...
				<svg @click="clearSearchField();"
					class=" absolute right-0 top-1/2 ml-4 mr-2 size-6 -translate-y-1/2 cursor-pointer rounded-full border border-high-contrast-text bg-ui-bg text-high-contrast-text dark:border-d-high-contrast-text dark:bg-d-ui-bg dark:text-d-high-contrast-text"
			...
			<div v-else
				...
				<h1 class=" text-center text-xl font-medium md:text-2xl">No results for {{ searchText }}.</h1>
			</div>
		</main>
