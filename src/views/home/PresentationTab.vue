  ...
  <div class="relative flex min-h-screen w-full">
    ...
    <main class=" container z-10 flex h-screen min-h-[740px] flex-col items-center justify-center gap-8 sm:gap-12">
        ...
        <div class="flex flex-col items-center justify-center gap-2 text-center">
          <h1 class="text-3xl font-extrabold text-high-contrast-text dark:text-d-high-contrast-text sm:text-4xl md:text-5xl" data-aos="zoom-in" data-aos-duration="1200">Hey, I’m Theo — aka DevJ2K</h1>
