<template>
	<div class="relative flex h-screen w-full">
		<BackgroundSpotlight color="bg-blue-500" rotate="bg-gradient-to-br"/>
		<main class="container z-10 flex h-screen w-full flex-col items-center justify-center">
			<h1 class=" text-2xl text-primary">About</h1>
...
<div class="is-active group relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse">
	<!-- Icon -->
	<div class="flex size-10 shrink-0 items-center justify-center rounded-full border border-white bg-slate-300 text-slate-500 shadow group-[.is-active]:bg-emerald-500 group-[.is-active]:text-emerald-50 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2">
	...
	<div class="w-[calc(100%-4rem)] p-4 md:w-[calc(50%-2.5rem)]">
		...
		<h2 class="mb-1 text-xl font-bold text-primary">September 2020</h2>
		<p class="text-primary">Minim anim sunt duis non dolor adipisicing consequat. Qui laboris deserunt laboris est enim velit fugiat voluptate sint qui adipisicing sint in..</p>
	</div>
