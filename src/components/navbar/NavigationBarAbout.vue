	...
	<div id="navBar" class="my-scroll-nav my-scroll-nav-active fixed top-0">
		...
		<div id="navMenu" class="absolute top-0 h-screen w-full -translate-x-full transition-transform duration-500 md:hidden">
			<ul
				...
				<li class="group relative w-max">
					<p class="cursor-pointer transition-all group-hover:text-black dark:group-hover:text-white" @click="backToHome">Home</p>
					<span
						class="animate-underline"></span>

				</li>
				<li class="group relative w-max">
					<p class="cursor-pointer transition-all group-hover:text-black dark:group-hover:text-white" @click="navigateTo('a_experiences')">Experiences</p>
					<span
						class="animate-underline"></span>

				</li>
				<li class="group relative w-max">
					<p class="cursor-pointer transition-all group-hover:text-black dark:group-hover:text-white" @click="navigateTo('a_feedbacks')">Feedbacks</p>
					<span
						class="animate-underline"></span>

				</li>
				<li class="group relative w-max">
					<p class="cursor-pointer transition-all group-hover:text-black dark:group-hover:text-white" @click="navigateTo('a_aboutme')">About Me</p>
					<span
					class="animate-underline"></span>

				</li>
				<li class="group relative w-max">
					<p class="cursor-pointer transition-all group-hover:text-black dark:group-hover:text-white" @click="navigateTo('a_3d')">3D</p>
					<span
						class="animate-underline"></span>
		...
		<div class="container flex items-center justify-between">
			...
			<ul class=" flex flex-row items-center justify-center gap-8 text-lg font-semibold text-high-contrast-text dark:text-d-high-contrast-text max-md:hidden">
				<li class="group relative w-max">
					<p class="cursor-pointer transition-all group-hover:text-black dark:group-hover:text-white" @click="navigateTo('a_experiences', false)">Experiences</p>
					<span
						class="animate-underline"></span>

				</li>
				<li class="group relative w-max">
					<p class="cursor-pointer transition-all group-hover:text-black dark:group-hover:text-white" @click="navigateTo('a_feedbacks', false)">Feedbacks</p>
					<span
						class="animate-underline"></span>

				</li>
				<li class="group relative w-max">
					<p class="cursor-pointer transition-all group-hover:text-black dark:group-hover:text-white" @click="navigateTo('a_aboutme', false)">About Me</p>
					<span
					class="animate-underline"></span>

				</li>
				<li class="group relative w-max">
					<p class="cursor-pointer transition-all group-hover:text-black dark:group-hover:text-white" @click="navigateTo('a_3d', false)">3D</p>
					<span
						class="animate-underline"></span>
