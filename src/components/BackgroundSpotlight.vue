<template>
  ...
  >
    <div :class="`absolute top-0 left-0 w-full h-[100%] bg-bg-${bgNb} dark:bg-d-bg-${bgNb} `"></div>

    <!-- <div :class="`absolute top-0 left-0 w-full h-[100%] ${bgClass}`"></div> -->

    <!-- <div class="absolute top-0 left-0 w-full h-[100%] bg-bg-1 dark:bg-d-bg-2"></div> -->
    ...
    <!-- <div :class="`absolute left-0 top-0 h-[${lineSize}] w-full ${rotate} from-bg from-40% via-accent-color via-50% to-bg to-60% dark:from-d-bg dark:from-40% dark:via-d-accent-color dark:via-50% dark:to-d-bg dark:to-60%`"></div> -->
